This Shiny app draws random samples from a number of different probability distributions and plots the samples and associated `plotmath` formulas using (almost entirely) base R functions.

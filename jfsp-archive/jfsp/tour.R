...
tour.pos <- c("left", "right", "bottom", "bottom", "bottom", "bottom", "top", "bottom", "right", "top", "top", "left", "left", "left",
             "bottom", "bottom", "bottom", "bottom", "left", "left")

tour.element <- c(
  "#shiny-tab-data", 
  ".sidebar-menu", "#Map", "#Map", "#Map", "#regions + .selectize-control", "#btn_staticmap",
  "#veg + .selectize-control", ".sidebar-menu",
